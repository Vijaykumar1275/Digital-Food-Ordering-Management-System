...
<body class="home">
    ...
    <section class="how-it-works">
        <div class="container">
            ...
            <a href="http://localhost/food-of-vijaysonke/fetch.php"> <button style="background-color: #007bff; color: white; padding: 10px 20px; border-radius: 25px; border: none; cursor: pointer;text-align: left : float:right;">We are Donated Food For Free</button></a>
        </div>
    </section>
    <!--  Author Name: MH RONY.
                        GigHub Link: https://github.com/dev-mhrony
