                                        ...
                                        <div class="col-lg-12">
                                            <div class="card card-outline-primary">
                                                <div class="card-header">
                                                    <h4 class="m-b-0 text-white">All Orders</h4><a href="http://localhost/food-of-vijaysonke/search.php"> <button style="background-color: #007bff; color: white; padding: 10px 20px; border-radius: 25px; border: none; cursor: pointer;text-align: left : float:right;">Search Here By Date</button></a>
                                                </div>
