...
*/ -->
            <div style="padding-top: 10px;">
                <marquee onMouseOver="this.stop()" onMouseOut="this.start()">For any of your problems messege us on whatsApp/insta <a href="https://www.instagram.com/vijay_sonke_28">VIJAYKUMAR</a>.........<a href="https://www.instagram.com/itz_.vishwa">VISHWANATH ANGADI</a>........<a href="">VISHWASA IP</a>..........<a href="">VISHWANATH M</a>.</marquee>
            </div>
...
*/ -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <a href="http://localhost/food-of-vijaysonke/fetch.php"> <button style="background-color: #007bff; color: white; padding: 10px 20px; border-radius: 25px; border: none; cursor: pointer;text-align: left : float:right;">Donated Food From US</button></a>
                            </div>
                            <a href="http://localhost/food-of-vijaysonke/donate.php"> <button style="background-color: #007bff; color: white; padding: 10px 20px; border-radius: 25px; border: none; cursor: pointer;text-align: left : float:right;">Donate Food Here</button></a>
                        </div>
